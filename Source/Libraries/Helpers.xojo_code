...
Protected Module Helpers
	...
	#tag Method, Flags = &h0
		Sub Log(Message as String, Type as Integer = 0)
		  ...
		  if AppSettings.ExperimentalMode then
		    // DReport
		    Select case Type
		    case 0 // Debug
	...
	#tag Method, Flags = &h0
		Function TypeOfException(Err as RuntimeException) As String
		  ...
		  ElseIf err isA OutOfMemoryException then
		    ...
		    // RBScript is not 64bit compatible
		    ...
		    'ElseIf err isA XojoScriptAlreadyRunningException then
		    'result = "Xojo Script Already Running Exception"
		    'ElseIf err isA XojoScriptException then
		    'result = "Xojo Script Exception"
